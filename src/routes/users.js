...
router.post('/', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var _a, email, company, password, scope, result;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, email = _a.email, company = _a.company, password = _a.password, scope = _a.scope;
                if (!email || !password) {
                ...
                return [4 /*yield*/, UserService_1["default"].create({ email: email, password: password, company: company, scope: scope })];
            case 1:
                result = _b.sent();
                res.json(result);
                return [2 /*return*/];
