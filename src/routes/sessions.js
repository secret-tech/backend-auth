 ...
 */
router.get('/:sessionKey', function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
    var sessionKey, result, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, KeyService_1["default"].get(sessionKey)];
            case 1:
                result = _a.sent();
